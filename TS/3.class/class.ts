...
/*
    접근제어자
    - public : 클래스 내부, 자식, 외부 등 모든 위치에서 접근 가능
...
// console.log(instance2.field2); 'field2' 속성은 보호된 속성이며 'Sample2' 클래스 및 해당 하위 클래스 내에서만 액세스할 수 있습니다.
// console.log(instance2.field3); 'field3' 속성은 private이며 'Sample2' 클래스 내에서만 액세스할 수 있습니다.

console.log('==================================================');

/*
    생성자 매개변수에 접근 제어자 지정
    - 생성자에 매개변수에 접근 제어자를 지정하여 필드 선언 가능
*/
class Sample3 {
...
// instance4.field1 = '변경'; >> 읽기 전용 속성이므로 'field1'에 할당할 수 없습니다.
