/*
    디스트럭처링 :
    - 구조화 되어있는 배열 혹은 객체를 비구조화, 구조화를 파괴하여 개별 변수로 할당하는 것
...
// const [...others, fruit] = fruits; >> rest연산자는 배열 파괴 구조의 마지막에 와야함
...
/*
    ...
    - 할당 기준은 키(Key) / 키 이름을 반드시 동일하게 맞출것
*/
let king2 = {
    name: '이방원',
    ho: '태종',
