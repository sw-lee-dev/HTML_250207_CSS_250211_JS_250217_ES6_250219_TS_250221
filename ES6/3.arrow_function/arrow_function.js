...
// 매개변수가 하나인 경우, 매개변수 위치의 소괄호를 제거할 수 있음
func = (arg) => {};
func = arg => {};
...
// 구현부가 구문 하나면 중괄호를 생략 가능, 만약 코드가 return 작업이라면 return 키워드를 제거해야함
func = (arg) => console.log(arg);
func = (arg) => arg * arg;

// 만약 구현부가 구문 하나이면서 객체 리터럴을 반환할 때는 함수의 코드 블럭을 제거했을 때 객체 리터럴을 소괄호로 묶어줘야 함
func = () => ({
    name: '홍길동',
    age: 30
});
