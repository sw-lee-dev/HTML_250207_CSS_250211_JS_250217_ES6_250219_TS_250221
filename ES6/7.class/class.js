/*
    클래스 정의 : class 키워드로 클래스르 정의
    - constructor 생성자를 이용해서 멤버 변수를 선언 및 초기화 가능
    - 생성자에서 this를 사용하여 맴버 변수를 지정할 수 있음
    - new 연산자로 인스턴스 생성 가능
*/
...
class Sample1 {
    ...
    constructor() {
        ...
        // this.staticPublicField = '클래스 변수';
    }
}

const instance1 = new Sample1();
console.log(instance1);
// console.log(instance1.#privateField); >> SyntaxError: Private field '#privateField' must be declared in an enclosing class
...
/*
    인스턴스 메서드와 정적 메서드 : 
    - 클래스 내부에서 function 키워드 없이 함수를 작성하여 인스턴스 메서드 선언 가능
    - static 키워드를 추가하여 클래스 메서드를 선언 가능 >> 반드시 클래스로 호출해야함
*/
class Sample3 {
...
// instance3.classMethod(); >> TypeError: instance3.classMethod is not a function
// console.log(instance3.classField); >> undefined
Sample3.classMethod();
console.log(Sample3.classField);
