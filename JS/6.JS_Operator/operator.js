/*
    ...
    - 산술 연산을 할 수 없는 상황이면 NaN 결과를 반환 (ex. 숫자와 숫자가 아닌것)
    - 이항 산술 연사관 단항 산술 연산이 존재
*/
...
// 선대입 후증가
result = single++ * 10; // result = 0
// 선증가 후대입
result = ++single * 10; // result = 20
// 선대입 후감소
result = single-- * 10; // result = 20
// 선감소 후대입
result = --single * 10; // result = 0
...
/*
    삼항 연산자 : 조건 표현식의 논리 결과에 따라 서로 다른 결과를 반환
    - 조건 표현식 ? true일 때 결과 : false일 때 결과
*/
var number = 10;
