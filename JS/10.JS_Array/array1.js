...
/*
    indexOf(element) : 
    - 배열에 매개변수로 전달한 요소가 존재한다면 첫번째 인덱스 값(중복요소가 있다면)을 반환
    - 존재하지 않으면 -1 을 반환
*/
...
/*
    ...
    - 매개변수로 전달된 값들을 배열의 마지막 요소 뒤에 연결하여 새로운 배열을 반환(부수효과 발생X - 본인의 값 변경X)
*/
...
/*
    slice(start, end) : 
    - start에 해당하는 인덱스부터 end에 해당하는 인덱스까지 복사하여 반환(부수효과 발생X - 본인의 값 변경X)
*/
...
*/
console.log(numbers.splice(1, 2, '추가', '추가2', '추가3'), numbers);
console.log(numbers.splice(1, 1), numbers); // 요소 제거용도로 사용하기도 함